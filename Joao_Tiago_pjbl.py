    ...
    if modo == 1:
        ...
        if senha != senha_escolhida:
            ...
            while opcao_saque_adicionar != 1 and opcao_saque_adicionar != 2 and opcao_saque_adicionar != 3:
                ...
                opcao_saque_adicionar = int(input("Deseja efetuar algum saque ou adicionar dinheiro ao caixa? Saque(1), Depositar dinheiro(2) e Seguir em frente(3): "))

            # Código para sacar dinheiro no modo ADM
            if opcao_saque_adicionar == 1:
                opcao_saque = int(input("Deseja sacar o valor total ou sacar diferentes notas/moedas? Valor total(1) Valor individual(2): "))
            ...
            # Código para depositar dinheiro
            ...
            print("\nAqui seguem o numero de vendas e seu faturamento:\nForam vendidas", vendas_coca, "latas de Coca-Cola e um total de faturamento de", faturamento_coca,
                  "reais\nForam vendidas", vendas_redbull, "latas de Redbull e um total de faturamento de", faturamento_redbull,
                  "reais\nForam vendidas", vendas_agua, "latas de Agua e um total de faturamento de", faturamento_agua, "reais")
            ...
            # Código para quando não há dinheiro no caixa
            if valor_total_caixa == 0:
                ...
                # Depositar dinheiro agora
                if adicionar_caixa_emergencia == 1:
                    valor_deposito = int(input("Para depositar: \n20 reais (1)\n10 reais (2)\n5 reais (3)\n2 reais (4)\n1 real (5)\n50 centavos (6)\n25 centavos (7)\n10 centavos (8)\n5 centavos (9)\nTerminar Deposito (0): "))
